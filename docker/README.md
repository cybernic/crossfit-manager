...
3. Update your system host file (add crossfit.test)
    ...
    $ sudo echo "171.17.0.1 crossfit.test" >> /etc/hosts
    ```
...
* Symfony app: visit [crossfit.test](http://crossfit.test)
* Symfony dev mode: visit [crossfit.test/app_dev.php](http://crossfit.test/app_dev.php)
* Logs (Kibana): [crossfit.test:81](http://crossfit.test:81)
